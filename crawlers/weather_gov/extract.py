...
# Configure logging
logging.basicConfig(filename="weather_gov.log", level=logging.INFO,
...
try:
    ...
    if response.status_code == 200:
        ...
        new_weather_gov_data["metadata"]["count"] = len(new_weather_gov_data["features"])
        ...
        print(f"New weather alert data saved to new_weather_gov_data.json (latest first)")
